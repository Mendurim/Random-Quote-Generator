...
// generate numbers for changing background colors
	...
	function changeBackground(){
	    ...
	    $("#quoteButton").css("background-color","rgba("+ colorR + "," + colorG + "," + colorB + "," + colorA + ")");
	}
	 	var element = documentGetById("#link");
	 	element.setAtrribute("data-text", element.getAttribute("data-text") + newQuote + newQuoteauthor); 
